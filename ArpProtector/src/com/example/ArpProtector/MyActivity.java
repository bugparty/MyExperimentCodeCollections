    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                tvStatus.setText(ArpReader.readAll());
            }
        });
        ...
        btnGateway = (Button) findViewById(R.id.btnGateway);
        btnGateway.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(mBoundService != null){
                    tvGateway.setText(mBoundService.getGatewayIP());

                }
                Log.d(TAG, "gateway mac"+ArpReader.readByIP("192.168.99.1"));
            }
        });
